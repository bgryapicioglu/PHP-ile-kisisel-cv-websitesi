  ...
  function formValidation() {
    if ($.exists('#contact-form #submit')) {
      ...
      $('#contact-form #submit').on('click', function () {
        ...
        if (!regex.test(email)) {
          $('#st-alert').fadeIn().html('<div class="alert alert-danger"><strong>Hata! </strong> Lütfen e-mail girin</div>');
          return false;
        }
        ...
        if (name != '' && email != '' && msg != '') {
          ...
          $.ajax({
            ...
            success: function () {
              ...
              $('#st-alert').fadeIn().html('<div class="alert alert-success"><strong>Başarılı! </strong> Mail gönderildi</div>');
              setTimeout(function () {
          ...
          $('#st-alert').fadeIn().html('<div class="alert alert-danger"><strong>Hata!</strong> Lütfen tüm alanları doldurun</div>');
        }
        return false;
      });
    }
